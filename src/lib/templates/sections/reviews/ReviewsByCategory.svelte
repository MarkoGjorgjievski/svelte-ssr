<div class="flex items-center mb-5">
	...
	<span class="w-1 h-1 mx-2 bg-gray-900 rounded-full dark:bg-gray-500" />
	<p class="text-sm font-medium text-gray-500 dark:text-gray-400">376 reviews</p>
	<a href="#" class="ml-auto text-sm font-medium text-blue-600 hover:underline dark:text-blue-500"
		>Read all reviews</a
	>
</div>
<div class="gap-8 sm:grid sm:grid-cols-2">
	<div>
		<dl>
			...
			<dd class="flex items-center mb-3">
				<div class="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
					<div class="bg-gray-700 h-1.5 rounded dark:bg-blue-500" style="width: 88%" />
				</div>
		...
		<dl>
			...
			<dd class="flex items-center mb-3">
				<div class="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
					<div class="bg-gray-700 h-1.5 rounded dark:bg-blue-500" style="width: 89%" />
				</div>
		...
		<dl>
			...
			<dd class="flex items-center">
				<div class="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
					<div class="bg-gray-700 h-1.5 rounded dark:bg-blue-500" style="width: 54%" />
				</div>
	...
	<div>
		...
		<dl>
			...
			<dd class="flex items-center mb-3">
				<div class="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
					<div class="bg-gray-700 h-1.5 rounded dark:bg-blue-500" style="width: 70%" />
				</div>
