	...
	>
		...
		>
			<div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
				<h3 class="font-bold text-gray-800 dark:text-gray-200">Plugins</h3>
				<button
					type="button"
				...
				<div class="sm:divide-y divide-gray-200 dark:divide-gray-700">
					<div class="py-3 sm:py-6">
						...
						<div class="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
							<!-- Card -->
							<a
								class="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]"
							...
							>
								<div class="flex">
									...
									<div class="grow ml-6">
										<h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">Tabs</h3>
										<p class="mt-1 text-sm text-gray-600 dark:text-gray-500">
											A framework for building web user interfaces.
										</p>
									</div>
							...
							>
								<div class="flex">
									...
									<div class="grow ml-6">
										<h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">
											Mega Menu <span
												class="ml-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/[.75] dark:border-blue-700 dark:text-blue-500"
												>Hot</span
											>
										</h3>
										<p class="mt-1 text-sm text-gray-600 dark:text-gray-500">
							...
							>
								<div class="flex">
									...
									<div class="grow ml-6">
										<h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">Dropdown</h3>
										<p class="mt-1 text-sm text-gray-600 dark:text-gray-500">
											A framework for building web user interfaces.
										</p>
									</div>
					...
					<div class="py-3 sm:py-6">
						...
						<div class="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
							...
							>
								<div class="flex">
									...
									<div class="grow ml-6">
										<h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">Modal</h3>
										<p class="mt-1 text-sm text-gray-600 dark:text-gray-500">
											A framework for building web user interfaces.
										</p>
									</div>
							...
							>
								<div class="flex">
									...
									<div class="grow ml-6">
										<h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">Popover</h3>
										<p class="mt-1 text-sm text-gray-600 dark:text-gray-500">
											A framework for building web user interfaces.
										</p>
									</div>
						...
						<p class="mt-4 text-xs text-gray-500">
							Completely unstyled, fully accessible UI <a
								...
								href="../plugins.html">plugins</a
							> for popular features that for one reason or another don't belong in core.
						</p>
					</div>
				</div>
			</div>
