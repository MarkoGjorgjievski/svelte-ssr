<form>
	...
	>
		<div
			class="relative h-40 rounded-t-xl bg-gray-100 dark:bg-gray-700 bg-[url('../svg/component/abstract-bg-1.svg')] bg-no-repeat bg-cover bg-center"
		>
		...
		<div class="pt-0 p-4 sm:pt-0 sm:p-7">
			...
			<div class="space-y-4 sm:space-y-6">
				...
				<div class="space-y-2">
					...
					<label
						for="af-submit-app-upload-images"
						class="group p-4 sm:p-7 block cursor-pointer text-center border-2 border-dashed border border-gray-200 rounded-lg focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 dark:border-gray-700"
					>
						<input
						...
						<span class="mt-2 block text-sm text-gray-800 dark:text-gray-200">
							Browse your device or <span class="group-hover:text-blue-700 text-blue-600"
								>drag 'n drop'</span
							>
						</span>
						<span class="mt-1 block text-xs text-gray-500"> Maximum file size is 2 MB </span>
					</label>
				</div>
