<div class="hs-dropdown relative inline-flex">
	...
	<!-- Dropdown menu -->
	<div
		class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg mt-2 dark:bg-gray-800 dark:border dark:border-gray-700"
	...
	>
		...
		<div class="divide-y divide-gray-100 dark:divide-gray-700 max-w-sm">
			<a
				href="/dashboard/calendar?event=32324324&dialog=confirm"
			...
			>
				...
				<div class="w-full pl-3">
					<div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">
						...
						<span class="font-medium text-blue-500">@bonnie.green</span> what do you say?
					</div>
			...
			>
				...
				<div class="w-full pl-3">
					<div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">
						<span class="font-semibold text-gray-900 dark:text-white">Robert Brown</span> posted a new
