				...
				>
					...
					>
						<div class="divide-y divide-gray-200 dark:divide-gray-700">
							<a class="flex py-2.5 px-3" href="/">
								<span class="ml-3 text-sm text-gray-800 dark:text-gray-200">English (US)</span>
							</a>
							<a class="flex py-2.5 px-3" href="/">
								<span class="ml-3 text-sm text-gray-800 dark:text-gray-200">Македонски (МК)</span>
							</a>
						</div>
					</div>
				</div>
