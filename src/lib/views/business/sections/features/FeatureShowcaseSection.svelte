<!-- Features -->
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="features">
	<!-- Tab Nav -->
	<nav
				...
				>
					...
					>
						<img
							...
							src="https://images.unsplash.com/photo-1533022139390-e31c488d69e2?auto=format&fit=crop&q=80&w=1932&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
							alt="Description"
						/>
					</div>
				</figure>
				...
				>
					...
					>
						<div class="flex space-x-1 absolute top-2/4 left-4 -translate-y-1">
							<span class="w-2 h-2 bg-gray-200 rounded-full dark:bg-gray-700" />
							<span class="w-2 h-2 bg-gray-200 rounded-full dark:bg-gray-700" />
							<span class="w-2 h-2 bg-gray-200 rounded-full dark:bg-gray-700" />
						</div>
						<div
		...
		>
			...
			<div class="max-w-[1140px] lg:pb-32 relative">
				...
				>
					...
					>
						<div class="flex space-x-1 absolute top-2/4 left-4 -translate-y-1">
							<span class="w-2 h-2 bg-gray-700 rounded-full" />
							<span class="w-2 h-2 bg-gray-700 rounded-full" />
							<span class="w-2 h-2 bg-gray-700 rounded-full" />
						</div>
						<div
