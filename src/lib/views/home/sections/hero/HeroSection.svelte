	...
	<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
		<div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
			...
			<div class="sm:flex sm:justify-center sm:items-center text-center sm:text-left">
				...
				<div
					class="border-t sm:border-t-0 sm:border-l border-gray-200 w-32 h-px sm:w-auto sm:h-full mx-auto sm:mx-0"
				/>
			...
			<!-- Form -->
			<div class="mt-7 sm:mt-12 mx-auto max-w-xl w-full relative">
				<form>
					<div
			...
			<div class="mt-10 sm:mt-20 mx-auto text-center">
				<a
					...
					href="categories/hair-salon/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					class="m-1 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
					href="categories/make-up/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					class="m-1 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
					href="categories/manicure/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					class="m-1 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
					href="categories/beauty-salon/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					class="m-1 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
					href="categories/massage/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					class="m-1 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
					href="categories/tattoo/listings/"
				>
					<svg
						class="w-3 h-auto"
						xmlns="http://www.w3.org/2000/svg"
