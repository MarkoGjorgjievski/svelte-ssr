...
<div class="mt-5 max-w-xl text-center mx-auto">
	<h1 class="block font-bold text-gray-800 text-3xl md:text-5xl lg:text-4xl dark:text-gray-200">
		Explore our <span class="text-blue-600">partners</span>
	</h1>
</div>
...
<div class="text-center my-4">
	<a
		class="inline-flex justify-center items-center gap-x-3 text-center bg-blue-500 hover:shadow-lg border border-transparent transition-all duration-300 text-white text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white py-3 px-6 dark:focus:ring-offset-gray-800"
		href="#"
	>
		Explore more
