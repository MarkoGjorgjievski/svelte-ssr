<span class="block font-medium text-gray-800 dark:text-gray-200 mb-2">Select staff member</span>

<!-- Grid -->
<div class="inline-flex flex-wrap gap-2">
	<div
		class="text-center cursor-pointer w-fit p-3 rounded-lg border ring-1 shadow-lg border-gray-200 shadow-sm text-sm border-blue-500 ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
	>
		<img
	...
	<div
		class="text-center cursor-pointer w-fit p-3 rounded-lg border-gray-200 text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
	>
		<img
			class="rounded-full w-20 h-20 mx-auto"
