...
<main id="content" role="main" class="relative">
	<!-- Gradients -->
	<div aria-hidden="true" class="flex absolute -top-48 left-0 z-10">
		<div
	...
	<div class="overflow-hidden">
		<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
			...
			<div class="max-w-2xl mx-auto text-center mb-10">
				...
				<p class="mt-2 lg:text-lg text-gray-800 dark:text-gray-200">
					Whatever your status, our offers evolve according to your needs.
				</p>
				<p class="lg:text-lg text-gray-800 dark:text-gray-200">
	...
	<div class="relative">
		<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
			...
			<!-- Header -->
			<div
				class="hidden lg:block sticky top-0 left-0 py-2 bg-white/60 backdrop-blur-md dark:bg-slate-900/60"
			>
				<!-- Grid -->
